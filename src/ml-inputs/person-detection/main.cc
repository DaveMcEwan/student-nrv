...
#include "src/ml-inputs/person-detection/dependencies/model_settings.h"
#include "person-detection/no_person_image_data.h"
#include "person-detection/person_image_data.h"
#include "tensorflow/lite/micro/micro_error_reporter.h"
#include "tensorflow/lite/micro/micro_interpreter.h"
#include "tensorflow/lite/micro/micro_mutable_op_resolver.h"
#include "person-detection/person_detect_model_data.h"
...
TF_LITE_MICRO_TEST(TestInvoke) {
  ...
  printf("microop resolver\n");
  tflite::MicroMutableOpResolver<5> micro_op_resolver;
  printf("Adding NN layers\n");
  ...
  printf("Checking if properties match\n");
  ...
  printf("Adding person image to input\n");
  ...
  printf("Checking output properties\n");
  ...
  // printf("Extracting scores for image with a person\n");
  ...
  printf("Adding no person image to input\n");
  ...
  // printf("Extracting scores for image without a person\n");
